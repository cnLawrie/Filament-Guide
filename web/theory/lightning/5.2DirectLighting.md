...
IES格式的文档资源很少，想要理解它最好的文档应该是[Parsing the IESNA LM-63 photometric data file](http://lumen.iee.put.poznan.pl/kw/iesna.txt)。间接地说，IES文件保存了光源周围不同角度上的光强。对于测量每个的水平角度时，还会提供不同垂直角度的一系列发光强度。然而，测量光源水平对称是相当常见的。
